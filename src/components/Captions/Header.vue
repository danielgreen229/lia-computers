...
<header class="site-header sticky-top py-1">
  <nav class="container d-flex flex-column flex-md-row justify-content-center gap-3">
    ...
    <a class="py-2 d-none d-md-inline-block" href="#plans">Продукты</a>
    <a class="py-2 d-none d-md-inline-block" href="#">Заказать</a>
    <a class="py-2 d-none d-md-inline-block" href="#">Соцсети</a>
  </nav>
</header>
</template>